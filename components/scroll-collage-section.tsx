...
const collageItems = [
  ...
  {
    type: "image",
    src: "/placeholder.svg?height=550&width=430",
    initialX: 1350,
    initialY: 700,
  ...
  {
    type: "image",
    src: "/placeholder.svg?height=380&width=500",
    initialX: 950,
    initialY: 1900,
  ...
  {
    type: "image",
    src: "/placeholder.svg?height=530&width=410",
    initialX: 1250,
    initialY: 2200,
...
export default function ScrollCollageSection() {
  ...
  const backgroundColor = useTransform(scrollYProgress, [0, 0.5, 1], ["#0a0f1a", "#0f172a", "#0a0f1a"])
      ...
      <div className="sticky top-0 h-screen">
        ...
        >
          {collageItems.map((item, index) => (
            ...
            >
              <div className="relative w-full h-full shadow-2xl rounded-lg overflow-hidden border border-dan-acid/20">
                <Image
                  src={item.src || "/placeholder.svg"}
                  alt={`DANVERSE project ${index}`}
                  fill
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0 pointer-events-none">
          <motion.h2
            ...
            className="text-dan-acid/15 font-black text-[4rem] md:text-[8rem] lg:text-[12rem] uppercase"
          >
            VISION
          </motion.h2>
        </div>
