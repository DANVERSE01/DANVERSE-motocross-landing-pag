        ...
        <div className="w-full overflow-hidden flex">
          ...
          >
            {[...Array(4)].map((_, i) => (
              <h2
                key={i}
                className="font-[family-name:var(--font-brier)] text-[12vw] md:text-[8vw] text-dan-acid leading-[0.9] tracking-tight px-4"
              >
                CINEMATIC AI PRODUCTION CINEMATIC AI PRODUCTION CINEMATIC AI PRODUCTION
              </h2>
            ))}
          </motion.div>
        </div>
        ...
        <div className="w-full overflow-hidden flex">
          ...
          >
            {[...Array(4)].map((_, i) => (
              ...
              >
                ACCELERATE YOUR VISION ACCELERATE YOUR VISION ACCELERATE YOUR VISION
              </h2>
            ))}
          </motion.div>
        </div>
